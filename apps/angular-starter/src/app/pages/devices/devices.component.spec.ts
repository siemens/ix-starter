...
describe('categories', () => {
  ...
  it('should have deviceName options matching unique device names in rowData', () => {
    const uniqueDeviceNames = [
      ...new Set(component.rowData.map((item: any) => item.deviceName)),
    ];
  ...
  it('should have vendor options matching unique vendors in rowData', () => {
    const uniqueVendors = [
      ...new Set(component.rowData.map((item: any) => item.vendor)),
    ];
  ...
  it('should have deviceType options matching unique device types in rowData', () => {
    const uniqueDeviceTypes = [
      ...new Set(component.rowData.map((item: any) => item.deviceType)),
    ];
  ...
  it('should have status options matching unique statuses in rowData', () => {
    const uniqueStatuses = [
      ...new Set(component.rowData.map((item: any) => item.status)),
    ];
  ...
  it('should have IPAddress options matching unique IP addresses in rowData', () => {
    const uniqueIPAddresses = [
      ...new Set(component.rowData.map((item: any) => item.IPAddress)),
    ];
