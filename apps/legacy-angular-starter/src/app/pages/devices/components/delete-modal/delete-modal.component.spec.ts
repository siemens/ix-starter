...
describe('DeleteModalComponent', () => {
  ...
  beforeEach(async () => {
    const activeModalSpy = jasmine.createSpyObj('IxActiveModal', [
      'close',
      'dismiss',
    ]);

    await TestBed.configureTestingModule({
      imports: [DeleteModalComponent, TranslateModule.forRoot()],
      providers: [
    ...
    mockActiveModal = TestBed.inject(
      IxActiveModal,
    ) as jasmine.SpyObj<IxActiveModal>;
  ...
  it('should have cancel and delete buttons', () => {
    ...
    expect(cancelButton.getAttribute('variant')).toBe('subtle-secondary');
    expect(deleteButton.getAttribute('variant')).toBe('danger-primary');
  });
});
